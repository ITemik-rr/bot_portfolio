        ...
        with con:
            ...
            cur.execute("""
                CREATE TABLE IF NOT EXISTS project_skills (
                    ...
                    skill_id INTEGER NOT NULL FOREIGN KEY  REFERENCES skills(skill_id),
                    project_id INTEGER NOT NULL FOREIGN KEY  REFERENCES projects(project_id),
                    UNIQUE(skill_id, project_id)  -- предотвращаем дублирование связей
                )
            """)
...
if __name__ == '__main__':
    ...
    manager.insert_project([(123,"бот про глобальное потепление", "https://github.com/ITemik-rr/global_problem", "Разработан. Готов к использованию")])
    manager.get_statuses()
    manager.update_projects( "url", ("https://github.com/ITemik-rr/tg_translate","бот про глобальное потепление", 123))
